...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("CʜᴀᴛGPT", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("𝐆ʀᴏᴜᴘs", callback_data="mplus HELP_Group"),InlineKeyboardButton("𝐒ᴛɪᴄᴋᴇʀs", callback_data="mplus HELP_Sticker")],
    ...
    InlineKeyboardButton("𝐆ᴀᴍᴇs", callback_data="mplus HELP_Game"),InlineKeyboardButton("Ⓣ-ɢʀᴀᴘʜ", callback_data="mplus HELP_TG")],
